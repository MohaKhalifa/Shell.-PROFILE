...
function shellem {Copy-Item -Path C:\Users\mohat\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1 -Destination C:\Users\mohat\gh\SP\; cd C:\Users\mohat\gh\SP;  lcommit; sl; home}